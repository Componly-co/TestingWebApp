...
exports.phaseResolveContexts = void 0;
...
exports.phaseResolveContexts = phaseResolveContexts;
function processLexicalScope(view, ops) {
    ...
    try {
        for (var ops_2 = __values(ops), ops_2_1 = ops_2.next(); !ops_2_1.done; ops_2_1 = ops_2.next()) {
            ...
            ir.transformExpressionsInOp(op, function (expr) {
                if (expr instanceof ir.ContextExpr) {
                    if (!scope.has(expr.view)) {
                        throw new Error("No context found for reference to view ".concat(expr.view, " from view ").concat(view.xref));
                    }
