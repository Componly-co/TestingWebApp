...
var CssSelector = (function () {
    ...
    CssSelector.prototype.unescapeAttribute = function (attr) {
        ...
        for (var i = 0; i < attr.length; i++) {
            ...
            if (char === '$' && !escaping) {
                throw new Error("Error in attribute selector \"".concat(attr, "\". ") +
    ...
    CssSelector.prototype.toString = function () {
        ...
        if (this.classNames) {
            this.classNames.forEach(function (klass) { return res += ".".concat(klass); });
        }
        if (this.attrs) {
            for (var i = 0; i < this.attrs.length; i += 2) {
                var name_1 = this.escapeAttribute(this.attrs[i]);
                var value = this.attrs[i + 1];
                res += "[".concat(name_1).concat(value ? '=' + value : '', "]");
            }
        }
        this.notSelectors.forEach(function (notSelector) { return res += ":not(".concat(notSelector, ")"); });
        return res;
    };
    return CssSelector;
}());
