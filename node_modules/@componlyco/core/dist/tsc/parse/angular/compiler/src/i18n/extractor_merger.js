...
var _Visitor = (function () {
            ...
            if (!this._inI18nBlock) {
                if (isOpening) {
                    if (!i18nCommentsWarned && console && console.warn) {
                        ...
                        var details = comment.sourceSpan.details ? ", ".concat(comment.sourceSpan.details) : '';
    ...
    _Visitor.prototype.visitBlockGroup = function (group, context) {
        html.visitAll(this, group.blocks, context);
    };
    _Visitor.prototype.visitBlock = function (block, context) {
        html.visitAll(this, block.children, context);
    };
    _Visitor.prototype.visitBlockParameter = function (parameter, context) { };
    ...
    _Visitor.prototype._translateAttributes = function (el) {
        ...
        attributes.forEach(function (attr) {
            ...
            if (attr.value && attr.value != '' && i18nParsedMessageMeta.hasOwnProperty(attr.name)) {
                ...
                if (nodes) {
                    if (nodes.length == 0) {
                        translatedAttributes.push(new html.Attribute(attr.name, '', attr.sourceSpan, undefined, undefined, undefined, undefined));
                    }
                    else if (nodes[0] instanceof html.Text) {
                        var value = nodes[0].value;
                        translatedAttributes.push(new html.Attribute(attr.name, value, attr.sourceSpan, undefined, undefined, undefined, undefined));
                    }
                    else {
                        _this._reportError(el, "Unexpected translation for attribute \"".concat(attr.name, "\" (id=\"").concat(id || _this._translations.digest(message), "\")"));
                    }
                }
                else {
                    _this._reportError(el, "Translation unavailable for attribute \"".concat(attr.name, "\" (id=\"").concat(id || _this._translations.digest(message), "\")"));
                }
            }
            else {
