...
exports.phaseNamespace = void 0;
var ir = __importStar(require("../../ir"));
function phaseNamespace(job) {
    var e_1, _a, e_2, _b;
    try {
        for (var _c = __values(job.views), _d = _c.next(); !_d.done; _d = _c.next()) {
            var _e = __read(_d.value, 2), _1 = _e[0], view = _e[1];
            var activeNamespace = ir.Namespace.HTML;
            try {
...
exports.phaseNamespace = phaseNamespace;
