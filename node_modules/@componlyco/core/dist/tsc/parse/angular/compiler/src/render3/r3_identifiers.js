...
var Identifiers = exports.Identifiers = (function () {
    ...
    Identifiers.defer = { name: 'ɵɵdefer', moduleName: CORE };
    Identifiers.deferWhen = { name: 'ɵɵdeferWhen', moduleName: CORE };
    Identifiers.deferOnIdle = { name: 'ɵɵdeferOnIdle', moduleName: CORE };
    Identifiers.deferOnImmediate = { name: 'ɵɵdeferOnImmediate', moduleName: CORE };
    Identifiers.deferOnTimer = { name: 'ɵɵdeferOnTimer', moduleName: CORE };
    Identifiers.deferOnHover = { name: 'ɵɵdeferOnHover', moduleName: CORE };
    Identifiers.deferOnInteraction = { name: 'ɵɵdeferOnInteraction', moduleName: CORE };
    Identifiers.deferOnViewport = { name: 'ɵɵdeferOnViewport', moduleName: CORE };
    Identifiers.deferPrefetchWhen = { name: 'ɵɵdeferPrefetchWhen', moduleName: CORE };
    Identifiers.deferPrefetchOnIdle = { name: 'ɵɵdeferPrefetchOnIdle', moduleName: CORE };
    Identifiers.deferPrefetchOnImmediate = { name: 'ɵɵdeferPrefetchOnImmediate', moduleName: CORE };
    Identifiers.deferPrefetchOnTimer = { name: 'ɵɵdeferPrefetchOnTimer', moduleName: CORE };
    Identifiers.deferPrefetchOnHover = { name: 'ɵɵdeferPrefetchOnHover', moduleName: CORE };
    Identifiers.deferPrefetchOnInteraction = { name: 'ɵɵdeferPrefetchOnInteraction', moduleName: CORE };
    Identifiers.deferPrefetchOnViewport = { name: 'ɵɵdeferPrefetchOnViewport', moduleName: CORE };
    Identifiers.conditional = { name: 'ɵɵconditional', moduleName: CORE };
    ...
    Identifiers.getComponentDepsFactory = { name: 'ɵɵgetComponentDepsFactory', moduleName: CORE };
    ...
    Identifiers.setClassMetadataAsync = { name: 'ɵsetClassMetadataAsync', moduleName: CORE };
    ...
    Identifiers.InputTransformsFeatureFeature = { name: 'ɵɵInputTransformsFeature', moduleName: CORE };
