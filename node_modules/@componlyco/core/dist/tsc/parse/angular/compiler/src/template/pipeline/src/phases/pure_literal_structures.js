...
exports.phasePureLiteralStructures = void 0;
...
exports.phasePureLiteralStructures = phasePureLiteralStructures;
function transformLiteralArray(expr) {
    var e_3, _a;
    var derivedEntries = [];
    var nonConstantArgs = [];
    try {
        for (var _b = __values(expr.entries), _c = _b.next(); !_c.done; _c = _b.next()) {
            var entry = _c.value;
            if (entry.isConstant()) {
                derivedEntries.push(entry);
            }
            else {
                var idx = nonConstantArgs.length;
