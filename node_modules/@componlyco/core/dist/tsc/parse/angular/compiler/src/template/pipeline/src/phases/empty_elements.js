...
exports.phaseEmptyElements = void 0;
...
function phaseEmptyElements(cpl) {
    ...
    try {
        for (var _c = __values(cpl.views), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            try {
                for (var _f = (e_2 = void 0, __values(view.create)), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var op = _g.value;
                    var opReplacements = REPLACEMENTS.get(op.kind);
                    if (opReplacements === undefined) {
                        continue;
                    }
                    var _h = __read(opReplacements, 2), startKind = _h[0], mergedKind = _h[1];
...
exports.phaseEmptyElements = phaseEmptyElements;
